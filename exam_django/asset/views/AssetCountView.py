...
class AssetCountView(ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        asset_type_counts = queryset.values("asset_type").annotate(count=Count("asset_type"))
        ...
        asset_type_names = {asset_type["id"]: asset_type["asset_type_name"] for asset_type in asset_types}
        ...
        for asset_type_count in asset_type_counts:
            ...
            asset_type_name = asset_type_names.get(asset_type_id, asset_type_id)  # Use asset_type_id if name not found
