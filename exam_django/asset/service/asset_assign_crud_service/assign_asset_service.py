...
# )
# from rest_framework import status
# from messages import UNAUTHORIZED_NO_PERMISSION, EMPLOYEE_NOT_FOUND_ERROR,STATUS_EXPIRED_OR_DISPOSED,ASSET_NOT_FOUND
# from asset.models import Employee
# from notification.service.EmailService import EmailService
# from rest_framework.renderers import JSONRenderer
# from asset.serializers import AssignAssetSerializer
...
# class AssignAssetService:
#     @staticmethod
#     def assign_asset(requester_role, asset, employee_id, requester,asset_uuid):
#         try:
#             employee = Employee.objects.get(id=employee_id)
#         except Employee.DoesNotExist:
#             return APIResponse(
