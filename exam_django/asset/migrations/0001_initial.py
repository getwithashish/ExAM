...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Memory',
            fields=[
                ('memory_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('memory_space', models.IntegerField(default=0, editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='Asset',
            fields=[
                ...
                ('custodian', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assets_custodian', to='asset.employee')),
