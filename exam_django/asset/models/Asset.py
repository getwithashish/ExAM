...
class Asset(models.Model):
    asset_uuid = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    ...
    model_number = models.CharField(max_length=255, null=True, blank=False, default=None)
    ...
    custodian = models.ForeignKey('Employee', related_name='assets_custodian', on_delete=models.CASCADE)
    ...
    location = models.ForeignKey('Location', related_name='assets_location', on_delete=models.CASCADE)
    invoice_location = models.ForeignKey('Location', related_name='assets_invoice_location', on_delete=models.CASCADE)
