...
from asset.models import Asset, AssetLog, Location, BusinessUnit, Memory, AssetType, Employee
...
class AssetLogViewTestCase(TestCase):
    def setUp(self):
        ...
        self.business_unit = BusinessUnit.objects.create(business_unit_name='IT Department')
        ...
        self.asset_log = AssetLog.objects.create(
            asset_uuid=self.asset,
            asset_log=json.dumps({'message': 'Asset created'})
        )
    ...
    def test_get_asset_logs_not_found(self):
        ...
        url = reverse('asset_logs', kwargs={'asset_uuid': '11111111-1111-1111-1111-111111111111'})
        response = self.client.get(url)
