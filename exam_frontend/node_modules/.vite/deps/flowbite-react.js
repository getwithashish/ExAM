...
var Checkbox = (0, import_react11.forwardRef)(({ className, ...props }, ref) => {
...
var getMiddleware = ({ arrowRef, placement }) => {
  ...
  middleware.push(placement === "auto" ? autoPlacement() : flip2());
...
var Floating = ({ children, content, theme: theme2, animation = "duration-300", arrow: arrow3 = true, placement = "top", style = "dark", trigger = "hover", closeRequestKey, className, ...props }) => {
  ...
  return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)("div", { className: theme2.target, ...getReferenceProps({ ref: reference }), "data-testid": "flowbite-tooltip-target", children }), (0, import_jsx_runtime20.jsxs)("div", { "data-testid": "flowbite-tooltip", ...getFloatingProps({
    ...
    ...props
  }), children: [(0, import_jsx_runtime20.jsx)("div", { className: theme2.content, children: content }), arrow3 && (0, import_jsx_runtime20.jsx)("div", { className: (0, import_classnames16.default)(theme2.arrow.base, {
...
var DropdownComponent = ({ children, className, dismissOnClick = true, ...props }) => {
  ...
  const [closeRequestKey, setCloseRequestKey] = (0, import_react16.useState)(void 0);
  const attachCloseListener = (node) => {
    ...
    if (node.props.children && typeof node.props.children === "object") {
      return import_react16.default.cloneElement(node, {
        children: import_react16.Children.map(node.props.children, attachCloseListener)
      });
    }
    return node;
  };
  const content = (0, import_react16.useMemo)(() => (0, import_jsx_runtime24.jsx)("ul", { className: theme2.content, children: import_react16.Children.map(children, attachCloseListener) }), [children, theme2]);
...
var ModalContext = (0, import_react18.createContext)(void 0);
function useModalContext() {
  const context = (0, import_react18.useContext)(ModalContext);
  if (!context) {
...
var ModalComponent = ({ children, show, root, popup, size: size2 = "2xl", position = "center", onClose, className, ...props }) => {
  const [parent, setParent] = (0, import_react19.useState)(root);
  const [container, setContainer] = (0, import_react19.useState)();
...
var NavbarContext = (0, import_react20.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react20.useContext)(NavbarContext);
  if (!context) {
...
var NavbarComponent = ({ children, menuOpen, fluid = false, rounded, border, className, ...props }) => {
  const [isOpen, setIsOpen] = (0, import_react21.useState)(menuOpen);
  const theme2 = useTheme().theme.navbar;
...
var Radio = (0, import_react23.forwardRef)(({ className, ...props }, ref) => {
...
var RatingContext = (0, import_react24.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react24.useContext)(RatingContext);
  if (!context) {
...
var Select = (0, import_react25.forwardRef)(({ children, sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var Tooltip = ({ animation = "duration-300", arrow: arrow3 = true, children, content, placement = "top", style = "dark", trigger = "hover", className, ...props }) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Floating, { content, style, animation, placement, arrow: arrow3, trigger, theme: theme2, className, ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Sidebar/SidebarContext.js
var import_react26 = __toESM(require_react());
var SidebarContext = (0, import_react26.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react26.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react27.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react27.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, icon: Icon, label, className, open = false, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react28.useState)(open);
  const theme2 = useTheme().theme.sidebar.collapse;
  (0, import_react28.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react29.forwardRef)(({ as: Component = "a", children, icon: Icon, active: isActive, label, labelColor = "info", className, ...props }, ref) => {
  var _a;
...
var TabsComponent = ({ children, style = "default", className, ...rest }) => {
  ...
  const tabs = (0, import_react31.useMemo)(() => import_react31.Children.map(children, ({ props }) => props), [children]);
  const tabRefs = (0, import_react31.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react31.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react31.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
...
var TableContext = (0, import_react32.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react32.useContext)(TableContext);
  if (!context) {
...
var Textarea = (0, import_react33.forwardRef)(({ shadow, helperText, color = "gray", className, ...props }, ref) => {
...
var TextInput = (0, import_react34.forwardRef)(({ sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var TimelineContext = (0, import_react35.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react35.useContext)(TimelineContext);
  if (!context) {
...
var ToastComponent = ({ children, duration = 300, className, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react37.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react37.useState)(false);
