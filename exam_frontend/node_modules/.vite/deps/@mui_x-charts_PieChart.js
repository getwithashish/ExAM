...
import {
  Typography_default
} from "./chunk-MF2HVLJV.js";
import "./chunk-JA7JNWQV.js";
import {
  Box_default,
  HTMLElementType,
  ...
  useThemeProps,
  useTheme_default
} from "./chunk-CQIW4OPF.js";
import {
  require_jsx_runtime
} from "./chunk-VOJZ7GSC.js";
import {
  require_prop_types
} from "./chunk-GBPQQXHW.js";
import {
  require_react
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React5.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React7.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React8.createElement(Provider, { value: props }, children);
};
    ...
    const getUpdate = (axisConfig, mouseValue) => {
      ...
      if (!isBandScale(scale)) {
        ...
        const closestIndex = axisData == null ? void 0 : axisData.findIndex((v, index2) => {
          ...
          if (v <= value) {
            if (index2 === axisData.length - 1 || Math.abs(value - v) < Math.abs(value - axisData[index2 + 1])) {
              return true;
            }
          }
          return false;
...
var HighlighContext = React13.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React13.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React21.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React23.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(React27.Fragment, {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types13.default.shape({
    ...
    series: import_prop_types13.default.shape({
      ...
      data: import_prop_types13.default.oneOfType([import_prop_types13.default.arrayOf(import_prop_types13.default.number), import_prop_types13.default.arrayOf(import_prop_types13.default.number), import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
      ...
      })), import_prop_types13.default.arrayOf(import_prop_types13.default.shape({
      ...
      id: import_prop_types13.default.oneOfType([import_prop_types13.default.number, import_prop_types13.default.string]).isRequired,
      type: import_prop_types13.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types13.default.func.isRequired
    }),
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React36.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime31.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime31.jsx)(ChartsAxisHighlightPath, {
...
var _excluded11 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React39.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React39.useMemo(() => data.map((item, itemIndex) => {
...
var _excluded12 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
var _excluded26 = ["startAngle", "endAngle", "paddingAngle", "innerRadius", "arcLabelRadius", "outerRadius", "cornerRadius"];
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime34.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime34.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
var _excluded14 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime36.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime36.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const seriesData = React43.useContext(SeriesContext).pie;
  const {
    left: left2,
    top: top2,
    width,
  ...
  return (0, import_jsx_runtime38.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime37.jsx)("g", {
        ...
        children: (0, import_jsx_runtime37.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime37.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime37.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime40.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime39.jsx)(ChartsAxis, {
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime39.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime39.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
  ...
  series: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    ...
    arcLabelRadius: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.string]),
    ...
    paddingAngle: import_prop_types24.default.number,
    sortingValues: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["asc", "desc", "none"]), import_prop_types24.default.func]),
