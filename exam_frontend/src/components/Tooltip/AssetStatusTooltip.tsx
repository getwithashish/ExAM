...
export const AssetStatusTooltip: FC<AssetStatusTooltipProps> = ({ isChartTooltip = false }) => {
    ...
    const statusDescription = `
      ...
      <br />
      ${isChartTooltip === true ? "<b>ACTIVE</b> - Includes all in-stock and in-use assets <br />" : ""}
      ...
      <br />
      ${isChartTooltip === true ? "<b>INACTIVE</b> - Includes all damaged, under-repair, or outdated assets <br />" : ""}
      <b>SCRAP</b> - Disposed, unused assets
    `
    return (
        < CustomTooltip title={
            < span dangerouslySetInnerHTML={{ __html: statusDescription }} />
        }> <InfoCircleOutlined hidden={!statusDescription}
