    ...
    () => [
      ...
      },
      {
        ...
        value: data.invoice_location ? (
          <FormItemField
            label="Asset Invoice Location"
            value={data.invoice_location}
            fieldName="invoiceLocation"
          />
        ) : null,
      },
      {
        ...
        name: "os",
        value: data.os ? (
          <FormItemField label="OS" value={data.os} fieldName="os" />
        ) : null,
      },
      {
        label: "OS Version",
      ...
      },
      {
        ...
        value: data.date_of_purchase ? (
          <FormItemField
            label="Date of Purchase"
            value={formatDate(data.date_of_purchase.toString())}
      ...
      },
      {
        ...
        name: "owner",
        value: data.owner ? (
          <FormItemField label="Owner" value={data.owner} fieldName="owner" />
        ) : null,
      },
      {
        label: "Requester",
      ...
      },
      {
        ...
        value: data.approval_status_message ? (
          <FormItemField
            ...
            value={data.approval_status_message}
            fieldName="approvalStatusMessage"
            isTextArea={true}
          />
        ) : null,
      },
