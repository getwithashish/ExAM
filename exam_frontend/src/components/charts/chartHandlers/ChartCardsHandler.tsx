      ...
      <div className="flex flex-wrap mx-auto px-auto items-center justify-center lg:gap-10 lg:px-16 lg:my-10 md:gap-20 lg:px-8 lg:my-5 sm:gap-20 sm:px-4 sm:my-2 ">
        ...
        <div
          ...
          style={{
            ...
            width: "13rem",
            boxShadow: "0 0 5px rgba(0, 0, 0, 0.5)",
            animation: "glow-teal 1.5s ease-in-out infinite",
          }}
        >
          <div
            className="absolute inset-0 rounded-full bg-custom-400"
        ...
        <div
          ...
          style={{
            ...
            width: "13rem",
            boxShadow: "0 0 5px rgba(0, 0, 0, 0.5)",
            animation: "glow-indigo 1.5s ease-in-out infinite",
          }}
        >
          <div
            className="absolute inset-0 rounded-full bg-custom-400"
        ...
        <div
          className="relative font-bold text-white rounded-full bg-gradient-to-r from-green-500 to-green-500 hover:from-green-400 hover:to-green-400 flex items-center justify-center"
          style={{
            height: "13rem",
            width: "13rem",
            boxShadow: "0 0 5px rgba(0, 0, 0, 0.5)",
