  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap mx-auto px-auto items-center justify-center lg:gap-10 lg:px-16 lg:my-10 md:gap-20 lg:px-8 lg:my-5 sm:gap-20 sm:px-4 sm:my-2">
        {[
          { label: "Asset count", value: totalAssets, gradient: "from-purple-800 to-purple-800" },
          { label: "Inventory", value: assetTypes[currentAssetIndex], gradient: "from-teal-600 to-teal-800" },
          { label: "Asset types", value: totalAssetTypes, gradient: "from-cyan-700 to-cyan-700" },
          { label: "Active Assets", value: activeAssets, gradient: "from-indigo-700 to-indigo-700" },
          { label: "Stock Assets", value: stockAssets, gradient: "from-blue-700 to-blue-700" },
          { label: "Assigned Assets", value: assignCount, gradient: "from-green-500 to-green-500" },
        ].map((item, index) => (
          <motion.div
            key={index}
            className={`relative mb-4 font-bold text-white rounded-full bg-gradient-to-r ${item.gradient} hover:from-purple-600 hover:to-purple-700 flex items-center justify-center`}
            style={{
              height: "13rem",
              width: "13rem",
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center z-10">
              ...
              <div className="text-white text-lg sm:text-lg md:text-lg lg:text-lg xl:text-lg font-display font-semibold text-right m-4">
                {item.value}
              </div>
            </div>
          </motion.div>
