// ParentFolder/handlers/ChartHandlers.tsx
...
import { AssetDetailData, ChartData, PieChartGraphProps, AssetData } from '../types/ChartTypes';
...
export const AllChartHandlers: React.FC<PieChartGraphProps> = () => {
